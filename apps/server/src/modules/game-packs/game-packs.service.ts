...
const questionRowSchema = z.object({
  ...
  answer_en: z.string().nullable(),
  answer_ar: z.string().nullable(),
  options_en: z.array(z.string()).length(4).nullable(),
  options_ar: z.array(z.string()).length(4).nullable(),
  correct_answer_index: z.union([z.literal(0), z.literal(1), z.literal(2), z.literal(3)]).nullable(),
...
function mapRowToQuestion(row: QuestionRow): GameQuestion {
  return {
    ...
    options_en: row.options_en as [string, string, string, string] | null,
